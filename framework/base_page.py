...
class BasePage:
    ...
    def wait_until_element_present(self, locator_data, timeout=5) -> WebElement | False:
        try:
            ...
            logging.info(f'Element was not found, "{locator_data}"')
            return False

    def find_element(self, locator_type, locator) -> WebElement | False:
        try:
